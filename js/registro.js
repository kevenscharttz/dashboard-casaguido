  ...
  // Adicionar classe "active" ao item de menu correspondente à página atual
  ...
  // Para dispositivos móveis (adicionar hamburger menu)
  // Primeiro, vamos adicionar o botão hamburger ao DOM se ainda não existir
  ...
  if (!document.querySelector('.hamburger-menu')) {
    ...
    navbarContainer.insertBefore(hamburgerMenu, navbarMenu);
    
    // Adicionar estilos para o hamburger menu
    ...
    hamburgerMenu.addEventListener('click', function() {
      ...
      hamburgerMenu.querySelector('.hamburger-icon').classList.toggle('open');
    });
  }
